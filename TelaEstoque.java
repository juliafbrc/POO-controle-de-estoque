...
public class TelaEstoque {
	...
	private void initialize() {
		...
		btnNewButton_Cadastrar.setForeground(Color.BLACK);
		btnNewButton_Cadastrar.setBackground(Color.ORANGE);
		...
		btnNewButton_Adicionar.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnNewButton_Adicionar.setForeground(Color.BLACK);
		btnNewButton_Adicionar.setBackground(Color.GREEN);
		...
		btnNewButton_Retirar.setForeground(Color.BLACK);
		...
		lblNewLabel_TituloTabela.setForeground(Color.BLACK);
		lblNewLabel_TituloTabela.setBounds(177, 116, 100, 14);
